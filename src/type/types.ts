...
export const Steps = {
  ...
  [ViewType.FREE_TO_PRO_WITH_LOCATION]: [View.OVERVIEW, View.LOCATION, View.TEAM, View.PAYMENT, View.CONFIRMATION],
  [ViewType.FREE_TO_PRO_WITH_USERS]: [View.OVERVIEW, View.TEAM, View.LOCATION, View.PAYMENT, View.CONFIRMATION],
